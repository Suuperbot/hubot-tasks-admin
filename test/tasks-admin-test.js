...
var tasksAdminHelper = new Helper('../src/tasks-admin.js');

chai.use(dirtyChai);

describe('hello:', function () {
  context('user says hello tasks admin', function () {
    var room = null;
    beforeEach(function () {
      room = tasksAdminHelper.createRoom();
    });
    afterEach(function () {
      room.destroy();
    });
    ...
    it('hubot responds hello', function () {
      ...
      var actual = [
        ['user', '@hubot hello tasks admin'],
        ['hubot', 'hello']
      ];

      return room.user.say('user', '@hubot hello tasks admin').then(function () {
